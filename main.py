...
if __name__ == '__main__':
    ...
    convertToFloat(ds)
    ds = sortByAvgRating(ds , 1)
    worstRated = sortByAvgRating(ds , 1).head(100)
    bestRated = sortByAvgRating(ds , 0).head(100)
    print(profitByGenre(worstRated))
    print(profitByGenre(bestRated))
